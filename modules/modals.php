                ...
                <div class="qr-code--grid">
                    <div class="qr-text--wrapper">
                        ...
                        <div class="button-wrapper">
                            <a href="https://apps.apple.com/us/app/#" class="app-download--btn" target="_blank">
                            ...
                            <a href="https://play.google.com/store/apps/details?id=tech.witty.global" class="app-download--btn" target="_blank">
                                <svg width="30" height="30" class="button-icon" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
