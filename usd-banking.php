...
<html lang="en">
    ...
    <body>
                ...
                <div class="row align-items-center">
                    <div class="col-lg-6 col-sm-12">
                        <div class="content-wrap wow fadeInUp" data-wow-delay=".2s">
                            ...
                            <div class="small-text">Manage your US Dollar finances seamlessly with Raiz. Convert currencies, track your balance, and make international transactions effortlessly.</div>
                        ...
                        <div class="feature-item--wrapper">
                            <div class="feature-item">
                                ...
                                <div class="copy-wrapper">
                                    <div class="large-text">Seamlessly manage your USD account anytime, anywhere.</div>
                                    <div class="small-text">Access your Raiz account and conduct transactions effortlessly, no matter where you are.</div>
                                </div>
                            </div>
                            ...
                            <div class="feature-item">
                                ...
                                <div class="copy-wrapper">
                                    <div class="large-text">Stay informed with real-time updates on your USD account</div>
                                    <div class="small-text">Never miss a beat with our instant notifications and detailed tracking.</div>
                                </div>
                            </div>
                            ...
                            <div class="feature-item">
                                ...
                                <div class="copy-wrapper">
                                    <div class="large-text">Convert between USD and NGN at competitive rates</div>
                                    <div class="small-text">Enjoy transparent exchange rates and hassle-free conversions.</div>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <section class="why-section product-why--section">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12 col-sm-12">
                        <div class="why-grid">
